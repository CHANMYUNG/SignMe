...
@API(category = Category.SURVEY, summary = "응답 없는 가정통신문 생성", successCode = 201, failureCode = 400, etc = "잘못된 요청 : 400, 비로그인 : 401, 권한 없음(관리자 아님) : 403")
@URIMapping(uri = "/letter/resposneless", method = HttpMethod.POST)

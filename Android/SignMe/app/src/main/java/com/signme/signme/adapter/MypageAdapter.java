...
import com.signme.signme.support.MypageItem;
...
public class MypageAdapter extends BaseAdapter {
  private ArrayList<MypageItem> listViewItemList = new ArrayList<MypageItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.image_iv) ;
        TextView titleTextView = (TextView) convertView.findViewById(R.id.iv_tv) ;

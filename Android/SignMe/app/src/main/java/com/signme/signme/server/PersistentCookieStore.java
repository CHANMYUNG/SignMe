...
/**
 * Created by dsm2016 on 2017-09-10.
 */
...
@Override public void add(URI uri, HttpCookie cookie) {
    ...
    // Save cookie into local store, or removeif expired
...
@Override
public List<HttpCookie> get(URI uri) { ArrayList<HttpCookie> ret = new ArrayList<>();
...
public List<URI> getURIs() {
    ...
    protected byte[] hexStringToByteArray(String hexString) {
        ...
        for (int i = 0; i < len; i += 2) { data[i / 2] = (byte) ((Character.digit(hexString.charAt(i), 16) << 4) + Character.digit(hexString.charAt(i + 1), 16));
        }
        return data;
    }
